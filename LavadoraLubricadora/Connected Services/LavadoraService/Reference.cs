...
namespace LavadoraLubricadora.LavadoraService {
    ...
    public interface ILavadoraService {
        ...
        int IngresarCliente(string nombre, string apellido, string telefono, string correo, string cedula, string direccion);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ILavadoraService/IngresarCliente", ReplyAction="http://tempuri.org/ILavadoraService/IngresarClienteResponse")]
        System.Threading.Tasks.Task<int> IngresarClienteAsync(string nombre, string apellido, string telefono, string correo, string cedula, string direccion);
        ...
        int EditarCliente(int id, string nombre, string apellido, string telefono, string correo, string cedula, string direccion);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ILavadoraService/EditarCliente", ReplyAction="http://tempuri.org/ILavadoraService/EditarClienteResponse")]
        System.Threading.Tasks.Task<int> EditarClienteAsync(int id, string nombre, string apellido, string telefono, string correo, string cedula, string direccion);
    ...
    public partial class LavadoraServiceClient : System.ServiceModel.ClientBase<LavadoraLubricadora.LavadoraService.ILavadoraService>, LavadoraLubricadora.LavadoraService.ILavadoraService {
        ...
        public int IngresarCliente(string nombre, string apellido, string telefono, string correo, string cedula, string direccion) {
            return base.Channel.IngresarCliente(nombre, apellido, telefono, correo, cedula, direccion);
        }
        
        public System.Threading.Tasks.Task<int> IngresarClienteAsync(string nombre, string apellido, string telefono, string correo, string cedula, string direccion) {
            return base.Channel.IngresarClienteAsync(nombre, apellido, telefono, correo, cedula, direccion);
        }
        
        public int EditarCliente(int id, string nombre, string apellido, string telefono, string correo, string cedula, string direccion) {
            return base.Channel.EditarCliente(id, nombre, apellido, telefono, correo, cedula, direccion);
        }
        
        public System.Threading.Tasks.Task<int> EditarClienteAsync(int id, string nombre, string apellido, string telefono, string correo, string cedula, string direccion) {
